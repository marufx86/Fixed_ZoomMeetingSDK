...
void MeetingVideoCtrlEvent::onVideoAlphaChannelStatusChanged(
    bool isAlphaModeOn) {}
void MeetingVideoCtrlEvent::onCameraControlRequestReceived(
    unsigned int userId, CameraControlRequestType requestType,
    ICameraControlRequestHandler *pHandler) {}
void MeetingVideoCtrlEvent::onCameraControlRequestResult(
    unsigned int userId, CameraControlRequestResult result) {}
