...
void MeetingParticipantsCtrlEvent::onParticipantProfilePictureStatusChange(
    bool bHidden) {}
void MeetingParticipantsCtrlEvent::onAllowParticipantsRequestCloudRecording(
    bool bAllow) {}
void MeetingParticipantsCtrlEvent::onFocusModeStateChanged(bool bEnabled) {}
void MeetingParticipantsCtrlEvent::onFocusModeShareTypeChanged(
    FocusModeShareType type) {}
