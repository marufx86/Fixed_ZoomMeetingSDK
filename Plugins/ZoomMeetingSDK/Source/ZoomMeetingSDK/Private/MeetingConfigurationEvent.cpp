...
void MeetingConfigurationEvent::onWebinarNeedInputScreenName(
    IWebinarInputScreenNameHandler *pHandler) {}
void MeetingConfigurationEvent::onJoinMeetingNeedUserInfo(
    IMeetingInputUserInfoHandler *pHandler) {}
void MeetingConfigurationEvent::onUserConfirmToStartArchive(
    IMeetingArchiveConfirmHandler *pHandler) {}
