...
void MeetingChatCtrlEvent::onFileSendStart(ISDKFileSender *sender) {}
void MeetingChatCtrlEvent::onFileReceived(ISDKFileReceiver *receiver) {}
void MeetingChatCtrlEvent::onFileTransferProgress(SDKFileTransferInfo *info) {}
