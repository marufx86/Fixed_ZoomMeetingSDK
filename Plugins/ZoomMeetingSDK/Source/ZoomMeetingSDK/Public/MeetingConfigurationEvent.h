...
public:
  ...
  void onWebinarNeedInputScreenName(
      IWebinarInputScreenNameHandler *pHandler) override;
  void
  onJoinMeetingNeedUserInfo(IMeetingInputUserInfoHandler *pHandler) override;
  void
  onUserConfirmToStartArchive(IMeetingArchiveConfirmHandler *pHandler) override;
