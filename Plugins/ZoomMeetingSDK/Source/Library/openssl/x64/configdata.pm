...
our %config = (
    ...
    "PERL" => "C:\\Dev\\vcpkg\\downloads\\tools\\perl\\5.38.0.1\\perl\\bin\\perl.exe",
    "RC" => "rc",
    "RCFLAGS" => [],
    "afalgeng" => "",
    "api" => "30100",
    ...
    "perlargv" => [
        ...
        "no-makedepend",
        "VC-WIN64A",
        "--prefix=C:\\Dev\\vcpkg\\packages\\openssl_x64-windows",
        "--openssldir=C:\\Dev\\vcpkg\\packages\\openssl_x64-windows",
        "AS=C:\\Dev\\vcpkg\\downloads\\tools\\nasm\\nasm-2.16.01\\nasm.exe",
        "CC=C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\VC\\Tools\\MSVC\\14.37.32822\\bin\\Hostx64\\x64\\cl.exe",
...
unless (caller) {
    ...
    use lib 'C:/Dev/vcpkg/buildtrees/openssl/x64-windows-rel/util/perl';
    use OpenSSL::fallback 'C:/Dev/vcpkg/buildtrees/openssl/x64-windows-rel/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib 'C:/Dev/vcpkg/buildtrees/openssl/x64-windows-rel/Configurations';
        use gentemplate;
